...
@section('content')
    ...
    <form action="{{ route('products.store') }}" method="post" enctype="multipart/form-data">
        ...
        <input type="number" name="shipping_cost" id="shipping_cost" class="mt-1 p-2 border rounded-md w-full" required>
        ...
        <button type="submit" style="background-color: #FF0054; color: white;" class="mt-4 px-4 py-2 rounded-full hover:bg-#FF003D focus:outline-none focus:border-#FF0072 focus:ring focus:ring-#FF0072">Add Product</button>
    </form>
@endsection
